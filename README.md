...
so you can remake the plots under `figs` without the need to rerun the
...
In order to run the analytical mathematical resolutions inside some Jupyter
notebooks, [SageMath](http://www.sagemath.org/) (>= 7.4) is needed. You can
either download it from its webpage or, if you are using Debian 9, install it
